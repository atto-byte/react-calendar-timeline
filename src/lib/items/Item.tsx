...
export type ItemState = {
  dragging: boolean,
  dragStart: { x: any, y: any, offset: number },
  preDragPosition: { x: any, y: any },
  dragTime: any,
  dragGroupDelta: number
} & { dragTime: any, dragGroupDelta: number } & {
  dragging: boolean,
  dragStart: null,
  ...
  resizeStart: any,
  resizeTime: number
} & { resizeEdge: any } & { resizeTime: any } & {
  resizing: null,
  resizeStart: null,
  resizeEdge: null,
  resizeTime: null
} & "tap" & { interactMounted: boolean } & {
